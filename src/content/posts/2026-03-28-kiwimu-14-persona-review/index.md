...
![kiwimu가 교과서로 생성한 나무위키 스타일 학습 위키 화면. 왼쪽에 원본·개념 문서 사이드바, 가운데에 '이진탐색트리' 문서의 목차와 시간 복잡도 표, LaTeX로 렌더링된 O(log n) 수식이 보인다.](/images/posts/kiwimu-14-persona-review/generated-wiki-overview.png)
...
![Dynamic Q&A 동작 화면. 본문에서 '회전(rotation)'을 드래그하자 새 개념 페이지 생성 팝오버가 뜨고, 관련 문서와 '트리 회전' 개념 페이지가 만들어진다. 상단 토스트에 '위키 페이지가 추가되었습니다', 왼쪽 사이드바 개념 수가 9로 늘어난 것이 보인다.](/images/posts/kiwimu-14-persona-review/dynamic-qa-new-page.png)
