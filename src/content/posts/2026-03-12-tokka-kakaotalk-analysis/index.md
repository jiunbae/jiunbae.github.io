...
![Tokka 랜딩 페이지 - 카톡 내보내기 파일을 드래그하거나 이메일로 보내면 분석이 시작된다](/images/posts/tokka-kakaotalk-analysis/landing.png)
...
![Tokka 분석 대시보드 데모 - 메시지 통계, 시간대별 대화량, 대화 스타일 레이더 차트 (샘플 데이터)](/images/posts/tokka-kakaotalk-analysis/demo-result.png)
